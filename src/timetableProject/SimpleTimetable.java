...
public static void engine() throws IOException{
	...
	public static void printSampleTimeTable(String roomName, String subjectName,String time, int t) {
		...
		{// if its a double day get the name of lab before
			
			System.out.println(time+" ; "+module[day][(t-1)]+" continues");
			
		}
		else if (trebleLab[day][t])
		{// if its treble get the name 2 before
	...
	public static String getRoomName(String room) {
		...
		{
			String rName = "";
			for (int c=42; c<=(room.length()-1);c++)// 42nd character is first word of the venue
	        {// 
